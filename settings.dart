...
class _SettingsState extends State<Settings> {
  ...
  Widget goalSettingList(){
    ...
    final settingInstructions = ["Type below to set your goal for daily step count", "Type below to set your goal for daily distance target(m)", "Type below to set your goal for daily calories to burn(Kcal)"];
